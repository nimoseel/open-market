...
import PaymentItem from '../../../components/buyer/PaymentItem/PaymentItem';
...
const Payment = () => {
    ...
    const orderer_mobile =
        orderer_mobile_1.value +
        orderer_mobile_2.value +
        orderer_mobile_3.value;
    const receiver_mobile =
        receiver_mobile_1.value +
        receiver_mobile_2.value +
        receiver_mobile_3.value;
    ...
    const total_product_price = calculateTotal(
        data.map((i) => i.price * i.quantity),
    );
    ...
    const onCompletePost = (post) => {
        ...
        address_1.setValue(
            post.buildingName
                ? post.address + ' (' + post.buildingName + ')'
                : post.address,
        );
    ...
    return (
        <>
            ...
            <S.ItemUl>
                {data?.map((item) => (
                    <PaymentItem {...item} key={item.product_id} />
                ))}
            </S.ItemUl>
            <S.TotalPriceDiv>
                ...
                <S.AddressDiv>
                    ...
                    <div>
                        <S.PostNumInput
                            ...
                            disabled
                        />
                        <S.PostNumSearchBtn onClick={handlePostCodeModal}>
                            우편번호 조회
                        </S.PostNumSearchBtn>
                        <S.AddressInput
                            placeholder="주소"
                    ...
                    <S.FinalContentDiv>
                        ...
                        <S.AgreementDiv>
                            ...
                            {isAllInputsValid() ? (
                                ...
                                <S.PaymentBtn type={'disabled'} disabled>
                                    결제하기
                                </S.PaymentBtn>
                            )}
                        </S.AgreementDiv>

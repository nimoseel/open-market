...
const ProductUpload = () => {
    ...
    useEffect(()=>{
        if(data){
            ...
            setShipping_method(data.shipping_method === 'DELIVERY' ? 'DELIVERY' : 'PARCEL');
            setImage(data.image);
    ...
    return (
        <>
                        ...
                        <div>
                            <S.InputWrapper>
                                ...
                                <S.ProductImgDiv>
                                    ...
                                    <input type='file' id='file' name='image' accept='image/*' onChange={onChangeFile} style={{display:'none'}}/>
                                </S.ProductImgDiv>
                            </S.InputWrapper>
                        </div>
                        <S.InfoInputsDiv>
                            ...
                            <S.InputWrapper>
                                ...
                                <S.BtnDiv>
                                    <S.ShippingBtn name='shipping_method' value={'PARCEL'} isFocused={methodChecked} onClick={handleShippingMethod} >택배,소포,등기</S.ShippingBtn> 
                                    <S.ShippingBtn name='shipping_method' value={'DELIVERY'} isFocused={!methodChecked} onClick={handleShippingMethod}>직접배송(화물배달)</S.ShippingBtn>
                                </S.BtnDiv>
                            </S.InputWrapper>
                            <S.InputWrapper>
            ...
            <S.FinalBtnDiv>
                ...
                { btnValid()?
                    <S.Btn type='green' onClick={data ? handleEditProduct : handlePostProduct}>저장하기</S.Btn>
                    :
